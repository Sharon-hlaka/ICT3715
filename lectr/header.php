...
<a href="#"  onclick = $("#menu-close").click(); >Lecturer Menu</a>
</li>
<li>
<a href="index.php" accesskey="1" onclick = $("#menu-close").click(); >Dashboard</a>
</li>
<li>
<a href="ifn.php" accesskey="2" onclick = $("#menu-close").click(); >View Info</a>
</li>
<li>
<a href="stdn.php" accesskey="3" onclick = $("#menu-close").click(); >My Students</a>
</li>
<li>
